...
![BlueCarbon library workflow](images/BC_workflow.png)
...
![Soil compaction from field sampling](images/compaction.png){width="339"}
...
![Gap distribution between samples to estimate accumulated organic carbon mass.](images/estimate_h().png){width="465"}
...
![OC stock estimation diagram](images/estimate_stock.png){width="446"}
