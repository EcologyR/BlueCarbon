...
![](https://img.shields.io/github/r-package/v/EcologyR/BlueCarbon) [![R-CMD-check](https://github.com/EcologyR/BlueCarbon/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/EcologyR/BlueCarbon/actions/workflows/R-CMD-check.yaml) [![codecov](https://codecov.io/gh/EcologyR/BlueCarbon/graph/badge.svg)](https://app.codecov.io/gh/EcologyR/BlueCarbon) 
...
![BlueCarbon library workflow](man/figures/BC_workflow.png)
...
![Soil compaction from field sampling](man/figures/compaction.png){width="339"}
...
If a model can not be created due to the low number of samples (\<10) it uses the equations in Fourqurean et al. 2012 for seagrasses, Maxwell et al. 2023 for salt marshes and Piñeiro-Juncal, in review, for mangroves to estimate the organic carbon.
...
Piñeiro-Juncal et al. (in review) Soil organic carbon preservation and decay trends in tidal marsh, mangrove and seagrass blue carbon ecosystems.
...
![Gap distribution between samples to estimate accumulated organic carbon mass.](man/figures/estimate_h().png){width="465"}
...
![OC stock estimation diagram](man/figures/estimate_stock.png){width="446"}
...
JA acknowledges funding from the CLIMB-FOREST Horizon Europe Project (No 101059888) that was funded by the European Union.
