...
#' ordered from the sample closed to the core soil surface to the deepest.
#' There are three ID columns: site, core, ecosystem and species. Site refers
#' to the ID given to the sampling location of the core. Core is the Id of
#' each individual core (replicate cores would have the same site IDs but
#' different cores IDs). Ecosystem refers to the type of ecosystem were the
#' core was collected and species to the type of vegetation in the sampling
#' area. Species could either be the name of the species or a code referring to
#' a mixture of different species (e.g. "Low", meaning the dominant species
#' usually found at low marsh areas).
#'
#' Compression indicates the percentage of compression suffered by the core
