...
![Blue Carbon package workflow](images/BC_workflow-01.png){width="527"}
...
![Soil compaction from field sampling](images/compaction.png){width="429"}
...
![Gap distribution between samples to estimate accumulated organic carbon mass](images/estimate_h().png){width="486"}
...
![Organic carbon stock estimation diagram](images/estimate_stock.png){width="408"}
