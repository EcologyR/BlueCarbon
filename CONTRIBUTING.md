...
This outlines how to propose a change to BlueCarbon. For a detailed
discussion on contributing to this package, please see the [development
contributing guide](https://rstd.io/tidy-contrib) and these [code review
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("EcologyR/BlueCarbon", fork = TRUE)`.
...
Code of
Conduct](https://ecologyr.github.io/BlueCarbon/CODE_OF_CONDUCT.md). By
